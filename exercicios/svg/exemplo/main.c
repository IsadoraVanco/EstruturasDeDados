...
int main(int argc, char const *argv[]){
    ...
    ArqSvg arquivo = abreEscritaSvg("arquivoTeste");
    ...
    escreveRetanguloSvg(arquivo, 50, 0, 10, 10, "");
    ...
    preparaDecoracaoTexto(arquivo, decoTexto, 200, "sans-serif", FS_ITALIC, FW_BOLD, "14px", "green", TA_START);
