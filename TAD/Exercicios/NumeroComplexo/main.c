/**
 * @file main.c
 * @brief Teste para os números complexos
 * 
 * Créditos ao prof° Gilberto, autor do exercício.
 * Implemente um TAD “Número Complexo” e implemente as seguintes operações:
 ...
 * Lembre-se que em números complexos, cada número possui os campos real e imaginário
*/
